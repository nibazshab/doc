...
使用 docker 镜像 [itzg/minecraft-server](https://github.com/itzg/docker-minecraft-server) 作官方纯净版服务器

服务器包下载地址：[https://www.minecraft.net/download/server](https://www.minecraft.net/download/server)
