...
使用 docker 镜像 [itzg/minecraft-server](https://github.com/itzg/docker-minecraft-server) 作官方纯净版服务器，服务器包请前往 [https://www.minecraft.net/download/server](https://www.minecraft.net/download/server) 下载

进入服务器控制台 rcon-cli，输入 `docker exec -i 容器名 rcon-cli` 即可
