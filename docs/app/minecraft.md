...
该游戏有两个版本，__Java 版__ 和 __基岩版__。Java 版是游戏的原始版本，自 2009 年开始开发。该版本可以在 Mac、Windows 和 Linux 上游玩。基岩版原为便携版，但后来被移植到不同的平台上。它当前支持 Windows 10、11 、Amazon FireOS、FireTV、Android、iOS、Xbox One、Playstation 4、Nintendo Switch 和 Samsung Gear VR 设备。基岩版客户端没有 Linux 的官方支持，但是基岩版服务器软件是可用的
