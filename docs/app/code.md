...
Arch 系的 Linux 系统（ 如 Arch / Manjaro 等 ），从 Aur 安装 [visual-studio-code-bin](https://aur.archlinux.org/packages/visual-studio-code-bin) 即可，其他系统请参考各自的安装方法，或前往 [官方下载地址](https://code.visualstudio.com/Download) 下载对应的包安装

## 安装 - Windows

直接前往 [官方下载地址](https://code.visualstudio.com/Download) 下载安装即可
