...
选择 Rules 列，在 Page Rules 中添加一条规则，URL 为重定向的域名，例如 `a.com/*`，Setting 设为 `Forwarding URL`，Status Code 设为 `301`，Destination URL 为重定向的目标域名，例如 `https://www.b.com/$1`。再添加第二条规则，其他设置与上述相同，将 URL 设为 `*.a.com/*`，Destination URL 设为 `https://$1.b.com/$2`
