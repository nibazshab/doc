...
Arch 系的 Linux 系统，从 Aur 安装 `visual-studio-code-bin` 即可，其他请参考各自的安装方法，或前往 [Visual Studio Code Download](https://code.visualstudio.com/Download) 下载对应的包安装

### Windows

直接前往 [Visual Studio Code Download](https://code.visualstudio.com/Download) 下载安装即可

## 扩展推荐

名称|介绍
-|-
Github Light Theme|亮色主题
One Dark Pro|暗色主题
