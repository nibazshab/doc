...
Arch 系的 Linux 系统，从 Aur 安装 `visual-studio-code-bin` 即可，其他请参考各自的安装方法，或前往 [Download Visual Studio Code](https://code.visualstudio.com/Download) 下载对应的包安装

### Windows

直接前往 [Download Visual Studio Code](https://code.visualstudio.com/Download) 下载安装即可
