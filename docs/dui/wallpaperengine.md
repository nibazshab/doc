...
在电脑上登陆过别的 Steam 账号之后，Steam 会自动将该账号的 Wallpaper 所订阅的创意工坊的内容添加到 WorkshopItemDetails 中，导致两者的内容不匹配

把 WorkshopItemsInstalled 的内容复制替换到 WorkshopItemDetails 中即可
